...
> Le présent document définit les règles d’engagement du logiciel LeBrigade, distribué librement, sans restriction, et placé volontairement dans le domaine public.  
Toute référence à des unités, structures ou terminologies militaires est purement esthétique et fictive.
...
> le logiciel LeBrigade, sous forme de code source ou de binaire, pour tout usage, civil ou non commercial, et par tout moyen.
- Aucune autorisation préalable n’est requise.
- Aucun rapport d’opération n’est exigé.
...
- irrévocable  
- perpétuelle  
- effectuée au bénéfice du public  

> Aucun droit présent ou futur ne sera revendiqué.
...
- réclamations  
- incidents  
- conséquences directes ou indirectes liés à l’utilisation du logiciel.
